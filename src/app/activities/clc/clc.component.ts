...
export class ClcComponent extends BaseComponent implements OnInit {

	constructor(private elm:ElementRef, 
				private sanitizer: DomSanitizer, 
				private playmedia: PlaymediaService, 
				private clclog: LoggingService, 
				private clccs: ColorschemeService,
				private clcpe: PickElementService,
				public drs: DisplayResultsService) {
		super(elm, sanitizer, playmedia, clclog, clccs, clcpe);
	}
